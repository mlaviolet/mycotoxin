# check counts of detected and quantified
...
main_data <- 
  read_xlsx(here("data-raw", 
                 "Toddler raw data with just LOQ 2026-06-10.xlsx"),
            na = c("nd", "np", "dn", "< 0"),
...
# try defining "quantified' as detected == "Detected" and 
#   amount between LOD and LOQ
# would then need to link LOQ and LOD data
